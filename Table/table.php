...
<body background="image\bank1.jpg">

    <div class="container">
        <nav class="navbar navbar-expand-lg ftco_navbar ftco-navbar-light" id="ftco-navbar">
        <div class="container">
        <a class="navbar-brand" href="#">JESSICA BANK</a>
        ...
        <div class="container">
            <h2>User</h2>
            <p class="justify-contend">Banking is the business of protecting money for others. Banks lend this money, generating interest that creates profits for the bank and its customers. A bank is a financial institution licensed to accept deposits and make loans. But they may also perform other financial services..</p>
...
?>
              <li class="table-row">
                ...
                <div class="col col-1"><?php echo $users['E-mail'] ?></div>
